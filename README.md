...
| Portfel | Ryzyko (σ) | Stopa zwrotu | Sharpe | Dominująca pozycja |
| :--- | :---: | :---: | :---: | :--- |
| Minimalnego ryzyka | 2,22% | 0,07% | -6,86% | GBP/PLN (86%) |
| Maksymalnej efektywności | 4,31% | 1,27% | 24,34% | ETF S&P 500 (74%) |

## 💡 Wnioski
- **GBP/PLN** okazał się najstabilniejszym instrumentem i zgodnie z teorią Markowitza zdominował portfel minimalnego ryzyka z udziałem 86%.
- **CD Projekt Red** wykazał największą zmienność, oferując jednocześnie najwyższą średnią stopę zwrotu (2,19%).
- Wszystkie korelacje między aktywami były ujemne lub nisko dodatnie, co potwierdza dobrą konfigurację portfela pod kątem dywersyfikacji ryzyka.
